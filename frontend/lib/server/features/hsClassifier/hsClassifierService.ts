...
import { HS_CLASSIFIER_PROMPT } from "../../config/systemPrompts";
import { TtlCache } from "../../utils/ttlCache";
import { logger } from "../../utils/logger";
import { ENV } from "../../config/env";
import type { HsClassifierRequest, HsClassifierResponse } from "../../types";
...
export async function classifyHsCode(
  ...
  if (ENV.OPENAI_API_KEY) {
    ...
    const model = gemini.getGenerativeModel({
      ...
      generationConfig: { responseMimeType: "application/json", maxOutputTokens: 2048 } as any,
    });
