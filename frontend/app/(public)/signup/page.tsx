...
export default function SignupPage() {
  return (
    <div className="flex min-h-screen bg-zinc-50 font-sans selection:bg-orange-100 selection:text-orange-900 antialiased">
      ...
      <div className="relative hidden w-full flex-col justify-between overflow-hidden bg-black p-12 lg:flex lg:w-[42%] xl:p-16 border-r border-zinc-900">
        ...
        <div className="relative z-10 my-auto max-w-sm">
          ...
          <p className="mb-10 text-sm leading-relaxed text-zinc-400 font-normal">
            Join India2World to manage export schemes, compliance workflows,
            and AI-powered trade guidance from one place.
          </p>

          {/* Premium List Items */}
          <div className="space-y-2.5">
            {[
              "Create your exporter workspace",
              "Track documents and compliance faster",
              "Get AI-powered export guidance instantly",
            ].map((feature, i) => (
              <div
                key={i}
      ...
      {/* ── Right Panel: Flat & Clean Sign Up Form ─────────────────────── */}
            ...
            appearance={{
              ...
              elements: {
                ...
                formResendCodeLink:
                  "text-xs font-medium text-orange-600 hover:text-orange-700 transition-colors",
                otpCodeFieldInput:
                  "h-11 rounded-lg border border-zinc-200 bg-zinc-50/50 text-sm font-medium text-zinc-900 focus:border-orange-500 focus:bg-white focus:ring-4 focus:ring-orange-500/5",
